...
public class C01_FirstMavenClass {
    ...
    public static void main(String[] args) {
       ...
       WebElement sonucSonucSayisi= driver.findElement(By.xpath("(//div[@class='a-section a-spacing-small a-spacing-top-small'])[1]"));
        System.out.println(sonucSonucSayisi.getText());
